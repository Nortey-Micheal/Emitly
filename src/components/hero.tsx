export default function Hero() {
    return (
        <div className="h-80 borde px-5 gap-12 flex flex-col my-16 text-center max-w-[800px] mx-auto">
            ...
            <button className="hover:cursor-pointer hover:bg-blue-100 hover:text-blue-500 bg-blue-400 py-3 px-6 rounded-3xl text-blue-50 font-bold w-fit self-center">Download App</button>
        </div>
    )
}