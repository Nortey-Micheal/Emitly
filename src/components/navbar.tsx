            ...
            <div className="container navbar ">
                <div className="navbar-start">
                    <div className="dropdown">
                        <div tabIndex={0} role="button" className="btn btn-ghost rounded-2xl hover:border-blue-400 lg:hidden">
                ...
                <div className="navbar-end flex gap-2 lg:gap-5">
                    <button className="hover:cursor-pointer text-slate-800 hover:underline underline-offset-3 decoration-2 decoration-blue-400 lg:text-lg rounded-4xl px-2 lg:px-6 py-1 lg:py-2 bg-blue-100  font-bold">Sign up</button>
                    <button className="hover:cursor-pointer hover:bg-blue-100 hover:text-slate-800 py-1 lg:py-2  px-2 lg:px-6 font-bold lg:text-lg bg-blue-400 text-blue-50 rounded-2xl lg:rounded-3xl">Get Started</button>
                </div>
            </div>
        </nav>
    )
