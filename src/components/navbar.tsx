        ...
        <nav className="sticky z-10 top-0 bg-blue-50 shadow-sm">
            <div className="container navbar ">
                ...
                <div className="navbar-end flex gap-2 lg:gap-5">
                    <button className="hover:cursor-pointer text-slate-800 hover:underline underline-offset-3 decoration-2 decoration-blue-400 rounded-4xl px-2 lg:px-6 py-1 lg:py-2 bg-blue-100  font-bold">Sign up</button>
